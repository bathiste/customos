...
$(BUILD)/shell.o: $(SRC)/shell.c $(SRC)/io.h $(SRC)/keyboard.h $(SRC)/fs.h $(SRC)/packages.h $(SRC)/tcp.h $(SRC)/udp.h $(SRC)/http.h $(SRC)/wifi.h | $(BUILD)
	$(CC) $(CFLAGS) -c $< -o $@
...
$(BUILD)/tcp.o: $(SRC)/tcp.c $(SRC)/tcp.h $(SRC)/virtio.h $(SRC)/string.h | $(BUILD)
	$(CC) $(CFLAGS) -c $< -o $@

$(BUILD)/udp.o: $(SRC)/udp.c $(SRC)/udp.h $(SRC)/virtio.h $(SRC)/string.h | $(BUILD)
	$(CC) $(CFLAGS) -c $< -o $@

$(BUILD)/http.o: $(SRC)/http.c $(SRC)/http.h $(SRC)/tcp.h $(SRC)/string.h $(SRC)/io.h | $(BUILD)
	$(CC) $(CFLAGS) -c $< -o $@
